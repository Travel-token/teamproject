...
export default function RoomSettleScreen({ route, navigation }: Props) {
    ...
    const onRoomTabChange = (key: RoomTabKey) => {
        if (key === 'expense') navigation.replace('RoomExpense', { tripId: route.params.tripId });
        else if (key === 'map') navigation.replace('RoomMap', { tripId: route.params.tripId });
    };
        ...
        <View style={[styles.screen, { backgroundColor: colors.bgScreen }]}>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 24 }}>
                ...
                <View style={styles.sectionHd}>
                    ...
                    <IconCircleButton icon="arrows-up-down" size={28} />
                </View>
